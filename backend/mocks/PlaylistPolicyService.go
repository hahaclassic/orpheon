...
// DeletePolicy provides a mock function with given fields: ctx, claims, playlistID
func (_m *PlaylistPolicyService) DeletePolicy(ctx context.Context, claims *entity.Claims, playlistID uuid.UUID) error {
	ret := _m.Called(ctx, claims, playlistID)
...
// PlaylistPolicyService_DeletePolicy_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'DeletePolicy'
type PlaylistPolicyService_DeletePolicy_Call struct {
	*mock.Call
}
...
//   - claims *entity.Claims
//   - playlistID uuid.UUID
func (_e *PlaylistPolicyService_Expecter) DeletePolicy(ctx interface{}, claims interface{}, playlistID interface{}) *PlaylistPolicyService_DeletePolicy_Call {
	return &PlaylistPolicyService_DeletePolicy_Call{Call: _e.mock.On("DeletePolicy", ctx, claims, playlistID)}
}

func (_c *PlaylistPolicyService_DeletePolicy_Call) Run(run func(ctx context.Context, claims *entity.Claims, playlistID uuid.UUID)) *PlaylistPolicyService_DeletePolicy_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(context.Context), args[1].(*entity.Claims), args[2].(uuid.UUID))
	})
	return _c
...
func (_c *PlaylistPolicyService_DeletePolicy_Call) Return(_a0 error) *PlaylistPolicyService_DeletePolicy_Call {
	_c.Call.Return(_a0)
	return _c
}

func (_c *PlaylistPolicyService_DeletePolicy_Call) RunAndReturn(run func(context.Context, *entity.Claims, uuid.UUID) error) *PlaylistPolicyService_DeletePolicy_Call {
	_c.Call.Return(run)
	return _c
}

// UpdatePrivacy provides a mock function with given fields: ctx, claims, playlistID, isPrivate
func (_m *PlaylistPolicyService) UpdatePrivacy(ctx context.Context, claims *entity.Claims, playlistID uuid.UUID, isPrivate bool) error {
...
// PlaylistPolicyService_UpdatePrivacy_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'UpdatePrivacy'
type PlaylistPolicyService_UpdatePrivacy_Call struct {
	*mock.Call
}
...
//   - playlistID uuid.UUID
//   - isPrivate bool
func (_e *PlaylistPolicyService_Expecter) UpdatePrivacy(ctx interface{}, claims interface{}, playlistID interface{}, isPrivate interface{}) *PlaylistPolicyService_UpdatePrivacy_Call {
	return &PlaylistPolicyService_UpdatePrivacy_Call{Call: _e.mock.On("UpdatePrivacy", ctx, claims, playlistID, isPrivate)}
}

func (_c *PlaylistPolicyService_UpdatePrivacy_Call) Run(run func(ctx context.Context, claims *entity.Claims, playlistID uuid.UUID, isPrivate bool)) *PlaylistPolicyService_UpdatePrivacy_Call {
	_c.Call.Run(func(args mock.Arguments) {
...
func (_c *PlaylistPolicyService_UpdatePrivacy_Call) Return(_a0 error) *PlaylistPolicyService_UpdatePrivacy_Call {
	_c.Call.Return(_a0)
	return _c
}

func (_c *PlaylistPolicyService_UpdatePrivacy_Call) RunAndReturn(run func(context.Context, *entity.Claims, uuid.UUID, bool) error) *PlaylistPolicyService_UpdatePrivacy_Call {
	_c.Call.Return(run)
	return _c
}
