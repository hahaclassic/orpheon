...
type TrackMetaService struct {
	...
	segmentService usecase.TrackSegmentService
}

func NewTrackMetaService(repo TrackMetaRepository, segmentService usecase.TrackSegmentService) *TrackMetaService {
