...
func (TrackMetaObjectMother) AdminClaims() *entity.Claims {
	return &entity.Claims{UserID: uuid.New(), AccessLvl: entity.AdminLvl}
}

func (TrackMetaObjectMother) UserClaims() *entity.Claims {
	return &entity.Claims{UserID: uuid.New(), AccessLvl: entity.UserLvl}
}
...
type TrackMetaServiceSuite struct {
	...
	ctx            context.Context
	service        *track.TrackMetaService
...
func (s *TrackMetaServiceSuite) SetupTest() {
	...
	s.service = track.NewTrackMetaService(s.repo, s.segmentService)
