...
// CreateAlbum provides a mock function with given fields: ctx, _a1
func (_m *AlbumRepository) CreateAlbum(ctx context.Context, _a1 *entity.AlbumMeta) error {
...
//   - ctx context.Context
//   - _a1 *entity.AlbumMeta
func (_e *AlbumRepository_Expecter) CreateAlbum(ctx interface{}, _a1 interface{}) *AlbumRepository_CreateAlbum_Call {
	return &AlbumRepository_CreateAlbum_Call{Call: _e.mock.On("CreateAlbum", ctx, _a1)}
}

func (_c *AlbumRepository_CreateAlbum_Call) Run(run func(ctx context.Context, _a1 *entity.AlbumMeta)) *AlbumRepository_CreateAlbum_Call {
...
// UpdateAlbum provides a mock function with given fields: ctx, _a1
func (_m *AlbumRepository) UpdateAlbum(ctx context.Context, _a1 *entity.AlbumMeta) error {
	ret := _m.Called(ctx, _a1)
...
//   - ctx context.Context
//   - _a1 *entity.AlbumMeta
func (_e *AlbumRepository_Expecter) UpdateAlbum(ctx interface{}, _a1 interface{}) *AlbumRepository_UpdateAlbum_Call {
	return &AlbumRepository_UpdateAlbum_Call{Call: _e.mock.On("UpdateAlbum", ctx, _a1)}
}

func (_c *AlbumRepository_UpdateAlbum_Call) Run(run func(ctx context.Context, _a1 *entity.AlbumMeta)) *AlbumRepository_UpdateAlbum_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(context.Context), args[1].(*entity.AlbumMeta))
	})
	return _c
