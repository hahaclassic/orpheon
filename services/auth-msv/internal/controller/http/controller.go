...
import (
	...
	"github.com/hahaclassic/orpheon/services/auth-msv/internal/controller/http/dto"
...
func NewAuthController(service usecase.AuthService,
	cookieTokensSetter *cookie.CookieTokensSetter,
...
func (ac *AuthController) register(c *gin.Context) {
	...
	tokens, err := ac.service.RegisterUser(c.Request.Context(), user, creds)
	if err != nil {
