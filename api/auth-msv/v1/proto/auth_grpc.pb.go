...
type AuthServiceClient interface {
	...
	GetClaims(ctx context.Context, in *AccessToken, opts ...grpc.CallOption) (*proto.Claims, error)
...
func (c *authServiceClient) GetClaims(ctx context.Context, in *AccessToken, opts ...grpc.CallOption) (*proto.Claims, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(proto.Claims)
...
type AuthServiceServer interface {
	...
	GetClaims(context.Context, *AccessToken) (*proto.Claims, error)
...
func (UnimplementedAuthServiceServer) GetClaims(context.Context, *AccessToken) (*proto.Claims, error) {
