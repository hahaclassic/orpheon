...
| **Сервис**              | **Доступность в РФ** | **Возможность создания пользовательских плейлистов и управления ими** | **Самые прослушиваемые моменты треков** | **Лицензии доступной музыки**             |
|-------------------------|----------------------|--------------------------------------------------------------------|---------------------------------------|------------------------------------------|
...
| **SoundCloud**           | +                    | +                                                                  | -                                     | Коммерческая, Creative Commons           |
...
![use-cases](./diagrams/use-cases-guest.png)

### Диаграмма для авторизованных пользователей

![use-cases](./diagrams/use-cases-users.png)

## ER-диграмма

![er-diagram](./diagrams/er-diagram-new.png)
